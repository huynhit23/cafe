...
namespace cafe.Migrations
{
    ...
    [Migration("20260312092332_AddLoyaltyAndCustomization")]
    partial class AddLoyaltyAndCustomization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cafe.Models.Feedback", b =>
                {
                    b.HasOne("cafe.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cafe.Models.Payment", b =>
                {
                    b.HasOne("cafe.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("cafe.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
